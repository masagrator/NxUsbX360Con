...
- Homebrew and server have code for reconnecting implemented, but it's finnicky, so you may need to restart homebrew/server to reeastibilish connection in case of closing app/homebrew and/or disconnecting USB while homebrew is running
